...
# Step 1: Login with Access Key
access_key = "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"  # Replace with your Hugging Face access key
login(token=access_key)

# # Step 2: Initialize LLM
mod = "gemma2-9b-it"  # Switch to a smaller, text-focused model
llm = ChatGroq(
    temperature=0,
    groq_api_key="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",
    model_name=mod,
    max_tokens=8000,  # Ensure requests stay within this limit
)
...
if __name__ == "__main__":
    ...
    pdf_path = "path_to_pdf"  # Change to your uploaded file path
